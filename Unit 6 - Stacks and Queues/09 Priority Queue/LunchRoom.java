   ...
   public static void main(String[] args)
   {
      ...
      while(min < TIME)
      {
         ...
         if(cus == 0)
         {
            ...
            if(type == 0)
            {
               Customer stud = new Customer(min, 9);
               queue.add(stud);
               nFr++;
            }
            else if(type == 1)
            {
               Customer stud = new Customer(min, 10);
               queue.add(stud);
               nSo++;
            }
            else if(type == 2)
            {
               Customer stud = new Customer(min, 11);
               queue.add(stud);
               nJu++;
            }
            else
            {
               Customer stud = new Customer(min, 12);
               queue.add(stud);
               nSe++;
            }
         ...
         if(!queue.isEmpty() && sTime ==-1)
         {
            int wait = (int)(Math.random()*6 + 2);
            sTime = min + wait;
            Customer stud = queue.remove();
            int grade = stud.getGrade();
            int time = stud.getTime();
            if(grade == 9)
            {
               int cusTime = min - time + wait;
               tFr += cusTime;
               if(cusTime > lFr)
                  lFr = cusTime;
            }
      ...
      System.out.println("Senior\t\t\t" + nSe + "\t\t\t" + lSe + "\t\t\t" + (double)tSe/nSe);
      System.out.println("Junior\t\t\t" + nJu + "\t\t\t" + lJu + "\t\t\t" + (double)tJu/nJu);
      System.out.println("Sophomore\t\t" + nSo + "\t\t\t" + lSo + "\t\t\t" + (double)tSo/nSo);
      System.out.println("Freshman\t\t\t" + nFr + "\t\t\t" + lFr + "\t\t" + (double)tFr/nFr);
