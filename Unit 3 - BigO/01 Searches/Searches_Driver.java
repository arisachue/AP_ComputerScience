//name: Arisa Chue   date: 10/23/2018
...
class Searches
{
   ...
   private static int binaryhelper(Comparable[] array, Comparable target, int start, int end)
   {
      ...
      {  
         ...
         {
            binaryCount++;
            return binaryhelper(array, target, t+1, end);
         }
         else
         {
            binaryCount++;
            return binaryhelper(array, target, start, t-1);
         }
      }
